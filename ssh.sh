...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://github.com/Alamyazid/rev/raw/main/badvpn-udpgw64"
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/Alamyazid/rev/main/bannerssh.conf"
echo "Banner /etc/issue.net" >>/etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/Alamyazid/rev/main/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -O user-limit "https://raw.githubusercontent.com/Alamyazid/rev/main/user-limit.sh"
